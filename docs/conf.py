#!/usr/bin/env python
#
# datasafari documentation build configuration file, created by
...
htmlhelp_basename = 'datasafaridoc'
...
latex_documents = [
    (master_doc, 'datasafari.tex',
     'Data Safari Documentation',
